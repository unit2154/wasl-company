...
import 'package:wasl_company_app/core/database/db_type_id.dart';
...
class ProfileModel extends ProfileEntity {
  ...
  ProfileModel({
    ...
    @HiveField(4) super.description,
    @HiveField(5) super.address,
    @HiveField(6) super.city,
    @HiveField(7) super.country,
